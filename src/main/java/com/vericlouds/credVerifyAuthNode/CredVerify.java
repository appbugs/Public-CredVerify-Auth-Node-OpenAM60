...
public class CredVerify {
	...
	private JSONObject callPasswordAPI(String passwordHash) throws Exception {
	...
	private JSONObject callUserIdAPI(String userid, String userid_type) throws Exception {
	...
	private JSONObject callRestAPI(String params) throws Exception {
