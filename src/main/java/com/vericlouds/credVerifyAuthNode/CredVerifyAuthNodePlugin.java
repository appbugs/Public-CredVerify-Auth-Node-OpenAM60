 ...
 */
public class CredVerifyAuthNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public CredVerifyAuthNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
